...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(281);

	var _componentsApp2 = _interopRequireDefault(_componentsApp);

	var _componentsRoutesList = __webpack_require__(311);

	var _componentsRoutesList2 = _interopRequireDefault(_componentsRoutesList);

	var _componentsRoutesContact = __webpack_require__(312);

	var _componentsRoutesContact2 = _interopRequireDefault(_componentsRoutesContact);

	var _componentsRoutesEdit = __webpack_require__(313);

	var _componentsRoutesEdit2 = _interopRequireDefault(_componentsRoutesEdit);
	...
	_reactDom2['default'].render(_react2['default'].createElement(
	  ...
	  _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(_reactRouter.IndexRoute, { component: _componentsRoutesList2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { path: '/new', component: _componentsRoutesEdit2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { path: '/:contact', component: _componentsRoutesContact2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { path: '/:contact/edit', component: _componentsRoutesEdit2['default'] })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexLink2 = __webpack_require__(268);
	...
	var _IndexRedirect2 = __webpack_require__(269);

	var _IndexRedirect3 = _interopRequireDefault(_IndexRedirect2);

	exports.IndexRedirect = _IndexRedirect3['default'];

	var _IndexRoute2 = __webpack_require__(271);

	var _IndexRoute3 = _interopRequireDefault(_IndexRoute2);

	exports.IndexRoute = _IndexRoute3['default'];

	var _Redirect2 = __webpack_require__(270);

	var _Redirect3 = _interopRequireDefault(_Redirect2);

	exports.Redirect = _Redirect3['default'];

	var _Route2 = __webpack_require__(272);
	...
	var _RouteContext2 = __webpack_require__(275);
	...
	var _PropTypes2 = __webpack_require__(266);

	var _PropTypes3 = _interopRequireDefault(_PropTypes2);

	exports.PropTypes = _PropTypes3['default'];

	var _match2 = __webpack_require__(276);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateHashHistory = __webpack_require__(236);

	var _historyLibCreateHashHistory2 = _interopRequireDefault(_historyLibCreateHashHistory);

	var _RouteUtils = __webpack_require__(250);

	var _RoutingContext = __webpack_require__(251);

	var _RoutingContext2 = _interopRequireDefault(_RoutingContext);

	var _useRoutes = __webpack_require__(254);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibActions = __webpack_require__(238);

	var _historyLibUseQueries = __webpack_require__(255);
	...
	var _getComponents = __webpack_require__(264);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Redirect = __webpack_require__(270);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateMemoryHistory = __webpack_require__(277);

	var _historyLibCreateMemoryHistory2 = _interopRequireDefault(_historyLibCreateMemoryHistory);

	var _historyLibUseBasename = __webpack_require__(278);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.sortByLastName = sortByLastName;
	...
	function getContacts(cb) {
		return (0, _browserRequest2['default'])('http://127.0.0.1:5000/contacts', function (error, response, body) {
	...
	function getContact(id, cb) {
		return (0, _browserRequest2['default'])('http://127.0.0.1:5000/contacts/' + id, function (error, response, body) {
			if (!error && response.statusCode == 200) {
				// console.log(body) // Show the HTML for the page.
				cb(JSON.parse(body));
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(282)['default'];

	var _inherits = __webpack_require__(296)['default'];

	var _createClass = __webpack_require__(307)['default'];

	var _classCallCheck = __webpack_require__(310)['default'];
	...
	var SearchContacts = (function (_React$Component) {
		_inherits(SearchContacts, _React$Component);

		function SearchContacts() {
			_classCallCheck(this, SearchContacts);

			_get(Object.getPrototypeOf(SearchContacts.prototype), 'constructor', this).apply(this, arguments);
		}

		_createClass(SearchContacts, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement('input', { id: 'search', type: 'text', placeholder: 'search', onChange: this.props.onChange });
			}
		}]);
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(SearchContacts, { onChange: this.handleChange.bind(this) })
					),
					_react2['default'].createElement(
						'div',
						{ className: 'pageInfo' },
						_react2['default'].cloneElement(this.props.children, { searchValue: this.state.searchValue })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyDescriptor = __webpack_require__(283)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(291)('getOwnPropertyDescriptor', function($getOwnPropertyDescriptor){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(KEY, exec){
	  var $def = __webpack_require__(292)
	    , fn   = (__webpack_require__(294).Object || {})[KEY] || Object[KEY]
	    , exp  = {};
	  exp[KEY] = exec(fn);
	  $def($def.S + $def.F * __webpack_require__(295)(function(){ fn(1); }), 'Object', exp);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$create = __webpack_require__(297)["default"];

	var _Object$setPrototypeOf = __webpack_require__(299)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDesc  = __webpack_require__(285).getDesc
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line no-proto
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(305)(Function.call, getDesc(Object.prototype, '__proto__').set, 2);
	        set(test, []);
		...
		_createClass(List, [{
			...
			value: function render() {
				...
				if (this.props.searchValue !== "none") {
					// is there a search value?
					var search = this.props.searchValue.toLowerCase();
				...
				contacts = contactsList.map(function (contact) {
					return _react2['default'].createElement(
						'li',
						{ className: 'media', key: contact.id, 'data-color': contact.color },
						_react2['default'].createElement(
							_reactRouter.Link,
							{ to: '/' + contact.id },
							_react2['default'].createElement(
								...
								_react2['default'].createElement('img', { className: 'media-object', src: contact.image, title: contact.first_name + ' ' + contact.last_name })
							),
							_react2['default'].createElement(
								'div',
				...
				if (this.state.contact) {
					...
					return _react2['default'].createElement(
						...
						_react2['default'].createElement(
							'div',
							{ className: 'media-left' },
							_react2['default'].createElement('img', { className: 'media-object', src: this.state.contact.image, title: this.state.contact.first_name + ' ' + this.state.contact.last_name })
						),
						_react2['default'].createElement(
							'div',
							{ className: 'media-body' },
							...
							_react2['default'].createElement('div', { className: 'color', style: contactColor, title: '#' + this.state.contact.color }),
							_react2['default'].createElement('br', null),
							_react2['default'].createElement(
								'h4',
								null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocationSelector = (function (_React$Component) {
		...
		function LocationSelector() {
			...
			_get(Object.getPrototypeOf(LocationSelector.prototype), 'constructor', this).apply(this, arguments);
		}
		...
		_createClass(LocationSelector, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'select',
					{ required: true, className: 'loc', name: 'location', onChange: this.props.onChange },
					_react2['default'].createElement(
						'option',
						{ value: '' },
						'select location'
				...
				if (this.state.contact) {
					...
					return _react2['default'].createElement(
						...
						_react2['default'].createElement(
							'div',
							{ className: 'media-left' },
							_react2['default'].createElement('img', { className: 'media-object', src: this.state.contact.image || "https://scontent.cdninstagram.com/hphotos-xaf1/t51.2885-15/e35/12080476_1160320367330373_838501514_n.jpg" })
						),
						_react2['default'].createElement(
							'div',
							{ className: 'media-body' },
							_react2['default'].createElement(
								...
								_react2['default'].createElement('input', { required: true, placeholder: 'enter first name', onChange: this.handleChange.bind(this), name: 'first_name', type: 'text', defaultValue: '' + this.state.contact.first_name }),
								...
								_react2['default'].createElement('input', { required: true, placeholder: 'enter last name', onChange: this.handleChange.bind(this), name: 'last_name', type: 'text', defaultValue: '' + this.state.contact.last_name }),
								_react2['default'].createElement('br', null),
								_react2['default'].createElement(
									'h4',
									null,
								...
								_react2['default'].createElement('input', { required: true, placeholder: 'enter title', onChange: this.handleChange.bind(this), name: 'title', type: 'text', defaultValue: '' + this.state.contact.title }),
								_react2['default'].createElement('br', { className: 'showWhenSmall' }),
								_react2['default'].createElement(
									'h4',
									{ className: 'rightInput' },
								...
								_react2['default'].createElement('input', { required: true, placeholder: 'enter team', onChange: this.handleChange.bind(this), name: 'team', type: 'text', defaultValue: '' + this.state.contact.team }),
								_react2['default'].createElement('br', null),
								_react2['default'].createElement(
									'h4',
									null,
								...
								_react2['default'].createElement(LocationSelector, { onChange: this.handleChange.bind(this) }),
								_react2['default'].createElement('br', null),
								_react2['default'].createElement(
									'h4',
									null,
								...
								_react2['default'].createElement('input', { required: true, onChange: this.handleChange.bind(this), name: 'image', type: 'text', defaultValue: '' + this.state.contact.image || "https://scontent.cdninstagram.com/hphotos-xaf1/t51.2885-15/e35/12080476_1160320367330373_838501514_n.jpg" }),
								_react2['default'].createElement('br', { className: 'showWhenSmall' }),
								_react2['default'].createElement(
									'p',
									{ className: 'instruct' },
									'A square picture, please.'
								),
								_react2['default'].createElement('br', null),
								_react2['default'].createElement(
									'button',
